/**
* node-pretty-print - nodejs plugin to pretty-print or minify text in XML, JSON and CSS formats.
*  
* Version - 0.20.0-beta
...
*
*	pd.xml(text ) - pretty print XML text;
*	pd.json(text) - pretty print JSON text;
*	pd.css(text ) - pretty print CSS text;
*
*	pd.xmlmin(text [, preserveComments] ) - minify XML text; 
...
*	var css_min  = require('./pd').pd.cssmin(css_text [, true]);
*/
